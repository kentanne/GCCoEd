<template>
		  ...
		  <div class="profile-information">
			...
			<div class="input-wrapper">
			  <div v-for="(item, index) in inputFieldProfileInformation" :key="index" class="input-fields">
				...
				<!-- Select Dropdown -->
				<div v-else-if="item.type === 'select' && item.field !== 'Subject of Interest'" class="custom-dropdown">
				  <div class="dropdown-container" @click.stop="toggleDropdown(toCamelCase(item.field))">
					<input
					  type="text"
				...
				<div v-else-if="item.field === 'Subject of Interest'" class="custom-dropdown">
				  <div class="dropdown-container" @click.stop="toggleDropdown(toCamelCase(item.field))">
					<input
					  type="text"
		  ...
		  <div class="bio-goals-grid">
			...
			>
			  ...
			  <textarea
				...
				:placeholder="item.field === 'Short Bio' ? 'Tell us about yourself' : 'Tell us your learning goals'"
			  ></textarea>
			</div>
		  </div>
		</div>
  ...
  const inputFieldProfileInformation = ref([
	{ field: "Learning Modality", type: "select", options: learningModalityOptions },
